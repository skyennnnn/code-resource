...
@WebServlet(name = "CompanyAddServlet")
public class CompanyAddServlet extends HttpServlet {
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        filepath = filepath
                .substring(0,filepath.indexOf(getServletContext()
        ...
        Company company = new Company(companyName,companyArea,companySize,
                companyType,companyBrief,companyState,companySort,0,newFileName);
        // 企业信息添加
